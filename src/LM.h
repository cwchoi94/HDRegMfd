...
double get_loss_LM(List X, mat LogY, List Xnew_, mat LogYnew, vec Ymu, String Yspace,
                   double lambda, int Xdim_max, double R=100, String penalty="LASSO", double gamma=0);

double get_loss_CV_LM(List X_, mat LogY, vec Ymu, String Yspace, double lambda, int Xdim_max, double R = 100, String cv_type = "AIC",
                      String penalty = "LASSO", double gamma = 0);
