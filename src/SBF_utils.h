...
double numerical_integral_1d(vec grids, vec func);
mat numerical_integral_3d_to_2d(vec grids, cube func);
cube numerical_integral_3d(vec grids, cube func1, cube func2);
