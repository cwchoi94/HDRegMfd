...
// [[Rcpp::export]]
List AM_CBS_GCV(arma::mat X, arma::mat LogY, arma::mat Xnew, arma::mat LogYnew, arma::vec Ymu, String Yspace, 
    arma::mat bandwidths_mat, arma::vec grids, arma::vec weights,
        ...
        if (r0 > 1 || iter == 0) {
            for (int j = 0; j < p; j++) {
                ...
                for (int i = 0; i < r0; i++) {
                    ...
                    loss0_j(i) = get_loss_CV_AM_average(SBF_comp_r, Xnew_r, LogYnew, Ymu, Yspace, opt_lambda, opt_R, 
