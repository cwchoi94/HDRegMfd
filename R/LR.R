...
#' }
#' @export
LR = function(Xorg,Yorg,Yspace,lambda=0.1,Xdim.max=100,R=100,phi=1,penalty='LASSO',gamma=0,
  ...
  # apply LR_each function in cpp
  object = LR_each(X,LogY,Ymu,inner,lambda,Xdim.max,R,phi,penalty,gamma,eta,max.iter,threshold)
