...
LR.kfold = function(Xall,Yall,Yspace,kfold,lambda.list,Xdim.max.list,R.list,phi=1,penalty,gamma=0,seed=NULL,
  ...
  # Use LR_kfold function defined in cpp
  result = LR_Kfold(Xorg.list,LogY.list,Xnew.list,LogYnew.list,Ymu.list,inner,kfold,
  ...
  object = LR(Xall,Yall,Yspace,opt.lambda,opt.Xdim.max,opt.R,phi,penalty,gamma,eta,max.iter,threshold)
